...
const REQUIRED = [
  ...
  'src/layouts/Layout.astro', 'src/components/SiteNav.astro', 'functions/[[path]].js',
  ...
  'scripts/generate-llm-dossiers.js', 'scripts/postbuild.js', 'scripts/verify-dist.js', 'scripts/verify-public-routing.mjs',
  'scripts/verify-rendering.js', 'public/.well-known/api-catalog',
  'public/.well-known/ard.json', 'public/.well-known/ai-catalog.json', 'public/auth.md',
