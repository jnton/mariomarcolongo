...
const entropyCaseHtml = `<article class="v8-case v8-case-red is-reversed" data-case="scientific-verification" data-reveal><div class="v8-case-media v10-entropy-panel v11-entropy-panel" role="group" aria-label="Mario Marcolongo's contribution and Entropy for Life production context"><header class="v11-panel-head"><span class="v11-kicker">Paid contractor · scientific content quality</span><h4>My work at Entropy for Life</h4><p>Evidence review, production support and publishing operations inside an established Italian science-communication brand.</p></header><div class="v11-work-grid"><div class="v11-output-stat"><strong>59+</strong><span>documented projects supported</span><small>55+ YouTube projects · 4 co-authored articles</small></div><div class="v11-role-map"><span class="v11-role-kicker">My contribution</span><div><strong>Evidence quality</strong><span>Primary literature &amp; scientific fact-checking</span></div><div><strong>Content production</strong><span>Scripts, visual assets &amp; selected thumbnails</span></div><div><strong>Publishing operations</strong><span>Website, hosting, DNS/SSL &amp; technical SEO</span></div></div></div><div class="v11-context-head"><strong>Production context</strong><span>Public brand metrics · 26 July 2026</span></div><div class="v11-platform-grid" aria-label="Current public Entropy for Life platform metrics"><div class="v11-youtube-card"><div class="v11-platform-name"><span class="v11-icon v11-icon--youtube" aria-hidden="true">${youtubeIcon}</span><strong>YouTube</strong></div><div class="v11-youtube-main"><strong>${CURRENT.youtubeViews}</strong><span>channel views</span></div><div class="v11-youtube-secondary"><span><strong>${CURRENT.youtubeSubscribers}</strong> subscribers</span><span><strong>${CURRENT.youtubeVideos}</strong> videos</span></div></div><div class="v11-secondary-platforms"><div class="v11-platform-row"><span class="v11-icon v11-icon--instagram" aria-hidden="true">${instagramIcon}</span><div><strong>Instagram</strong><span>${CURRENT.instagramFollowers} followers</span></div></div><div class="v11-platform-row"><span class="v11-icon v11-icon--tiktok" aria-hidden="true">${tiktokIcon}</span><div><strong>TikTok</strong><span>${CURRENT.tiktokFollowers} followers · ${CURRENT.tiktokLikes} likes</span></div></div></div></div><div class="v11-performance"><strong>Performance-aware packaging</strong><ul><li>CTR</li><li>Watch time</li><li>Retention</li><li>Attention capture</li></ul></div><a class="v11-evidence-link" href="https://www.youtube.com/playlist?list=PLMJaM7iJky4pKj6voGlUNHBnGdTj9rJNh" target="_blank" rel="noopener noreferrer"><span>Open 55+ documented YouTube projects</span><i aria-hidden="true">↗</i></a><p class="v11-scope-note">Platform metrics describe the production environment, not Mario's personal audience. The combined cross-platform following is approximately ${CURRENT.combinedFollowers} and non-unique; it is deliberately secondary to Mario's documented work and responsibilities.</p></div><div class="v8-case-copy"><div class="v8-case-index"><span>02</span><strong>Scientific content quality &amp; operations</strong></div><h3>Scientific content quality across research, production and publishing.</h3><p class="v8-case-lead">Paid contractor supporting Entropy for Life, an Italian science-communication brand with ${CURRENT.youtubeSubscribers} YouTube subscribers and ${CURRENT.youtubeViews} channel views.</p><dl class="v8-case-details"><div><dt>What I owned</dt><dd>Primary-literature research and scientific fact-checking across documented productions. Depending on the assignment, I translate evidence into scripts, data visualizations, slides and on-screen assets; develop selected thumbnails and performance-aware visual packaging informed by click-through rate, watch time, retention and attention capture; and manage WordPress, hosting, DNS/SSL and technical SEO.</dd></div><div><dt>Result</dt><dd>59+ documented projects supported: 55+ YouTube video projects and 4 co-authored articles, with a cross-functional remit spanning evidence quality, content production and publishing operations.</dd></div></dl><p class="v8-scope-note"><strong>Scope:</strong> Audience and channel metrics describe the production environment, not a personal audience or a causal performance claim. Quantified thumbnail lift is stated only when comparable analytics are available.</p><div class="v8-case-links" aria-label="Scientific content quality and operations evidence links"><a class="v8-text-link" href="https://www.youtube.com/playlist?list=PLMJaM7iJky4pKj6voGlUNHBnGdTj9rJNh" target="_blank" rel="noopener noreferrer">55+ documented YouTube projects<span aria-hidden="true">↗</span></a><a class="v8-text-link" href="https://entropyforlife.it/autore/mario-marcolongo/" target="_blank" rel="noopener noreferrer">4 co-authored articles<span aria-hidden="true">↗</span></a><a class="v8-text-link" href="https://www.youtube.com/playlist?list=PLUXju4zC0Sks" target="_blank" rel="noopener noreferrer">Selected thumbnail work<span aria-hidden="true">↗</span></a><a class="v8-text-link" href="https://entropyforlife.it" target="_blank" rel="noopener noreferrer">Official Entropy for Life website<span aria-hidden="true">↗</span></a></div></div></article>`;
