...
const CURRENT_NOTANDIA_BODY = 'Originally released as MDPI Filter, Notandia now lets researchers flag articles from publishers they choose to monitor and check Crossref/Retraction Watch data for formal notices such as retractions, corrections and expressions of concern. The Zotero plugin currently focuses on precise MDPI item and reference detection. Publisher flags are user-selected context, not a quality verdict.';
