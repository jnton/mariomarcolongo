  ...
  "ai-safety": {
    evidence: {
      0: {
        ...
        body: "Created and operate Notandia (formerly MDPI Filter), a browser and Zotero research-integrity tool. It helps researchers identify articles from publishers they choose to monitor and uses Crossref/Retraction Watch data to check for formal notices such as retractions, corrections and expressions of concern. I define the evidence rules, privacy safeguards, ambiguity handling, false-positive boundaries and release tests.",
        link: "/notandia.html"
      }
    }
  },
  "research-quality": {
    evidence: {
      1: {
        ...
        body: "Notandia helps researchers identify articles from publishers they choose to monitor and check for formal post-publication notices in the browser, while its Zotero plugin currently focuses on precise MDPI item and reference detection. It uses DOI, domain, metadata, PMID/PMCID and structured PubMed Central evidence, and skips uncertain matches rather than guessing.",
        link: "/notandia.html"
      },
      2: {
